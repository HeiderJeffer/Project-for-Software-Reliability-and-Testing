...
public class Checker {
	 ...
	 * @param companyList the Settings
	 * @param settings2 
	 * @param combinationLine the CombinationLine
	 * @return the IFRS16Contract
	 */
	public IFRS16Contract createIFRS16Contract(ArrayList<Company> companyList, Settings settings2, CombinationLine combinationLine) {
		
		CombinationParser combinationParser = new CombinationParser(companyList, true, true, this);
